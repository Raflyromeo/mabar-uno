            ...
            >
              <div className="flex items-center justify-between px-5 sm:px-7 pt-5 sm:pt-7 pb-4 shrink-0">
                <div>
                  ...
                  <p className="text-white/40 text-xs sm:text-sm mt-0.5">{t.infoSubtitle}</p>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="px-5 sm:px-7 mb-2 shrink-0">
                <p className="text-[10px] sm:text-xs font-bold text-white/35 uppercase tracking-[0.2em]">{t.infoHowToPlay}</p>
              </div>
              ...
              <div className="px-5 sm:px-7 pb-5 sm:pb-7 pt-3 border-t border-white/10 shrink-0">
                <p className="text-[10px] sm:text-xs font-bold text-white/35 uppercase tracking-[0.2em] mb-3">{t.infoConnect}</p>
